        ...
        <div>
            <div className='w-4/5 md:w-2/5 mx-auto my-12 p-8 shadow-xl rounded-lg bg-form'>
                ...
                <form onSubmit={handleRegistration}>
                    ...
                    <p className='text-base md:text-lg font-secularOne font-medium text-center'>Already have an account <Link to='/login' className='text-lime-600'>Register</Link></p>
                </form>
