    ...
    return (
        <div>
            <div className='bg-img1 flex items-center justify-center ps-10'>
                <h1 className='text-2xl md:text-8xl font-paytonOne text-base-300'>User <span className='text-yellow-400'>Login</span></h1>
            </div>
            <div className='w-4/5 md:w-2/5 mx-auto my-12 p-8 shadow-xl rounded-lg bg-form'>
                ...
                <div>
                    <button onClick={handleLoginWithGoogle} className='btn btn-block bg-slate-600 font-secularOne font-medium text-base md:text-lg'><FaGoogle className='mx-5'></FaGoogle> Signin with Google</button>
                </div>
            </div>
        </div>
    );
